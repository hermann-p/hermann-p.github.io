...
var or__6247__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__13644 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__13644;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__6235__auto__ = id;
...
if(cljs.core.truth_((function (){var or__6247__auto__ = id;
if(cljs.core.truth_(or__6247__auto__)){
return or__6247__auto__;
} else {
return cs;
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__6853__auto__,writer__6854__auto__,opt__6855__auto__){
return cljs.core._write.call(null,writer__6854__auto__,"hipo.hiccup/Sentinel");
});
...
var G__13646 = (function (){var f = cljs.core.first.call(null,s);
if(cljs.core.truth_((function (){var or__6247__auto__ = hipo.hiccup.literal_QMARK_.call(null,f);
if(cljs.core.truth_(or__6247__auto__)){
return or__6247__auto__;
} else {
...
var G__13647 = cljs.core.rest.call(null,s);
v = G__13646;
s = G__13647;
continue;
} else {
...
var G__13648 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__13649 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__13648;
v__$1 = G__13649;
continue;
}
